...
window.top.document.getElementById("form_name").preview_image.src=url;
window.top.document.getElementById("form_name").src.value=url;
...
window.top.return_image_parameters();
      ...
      case 'link':
        echo '
window.top.document.getElementById("form_name").href.value=\''.correct_path($files_url.$name).'\';
window.top.window.is_local_file = false;
		';
...
window.top.return_link_parameters();
      ...
      case 'flash':
        echo '
window.top.flash_src = \''.correct_path($files_url.$name).'\';
...
var div_obj = parent_win.document.getElementById('re_loading_div_id');
	div_obj.style.top = 2*(parseInt(parent_win.outerWidth)-50)/5+'px';
	div_obj.style.left = 2*(parseInt(parent_win.outerHeight)-120)/5+'px';
	div_obj.style.display = '';

	//disable src or href properties' fields
	var parent_form = parent_win.document.getElementById('form_name');
	...
	try {
		parent_win.document.getElementById('remote_files').contentDocument.getElementById('re_loading_div_id').style.display = '';
		parent_win.document.getElementById('local_files').contentDocument.getElementById('re_loading_div_id').style.display = '';
	} catch(e) {}
...
var div_obj = parent_win.document.getElementById('re_loading_div_id');
	...
	try {
		parent_win.document.getElementById('remote_files').contentDocument.getElementById('re_loading_div_id').style.display = 'none';
	} catch(e) {}
}
...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" onload="on_load_local();">
...
<form name="local_files_form" id="local_files_form" method="post" enctype="multipart/form-data" action="" onsubmit="show_loading_div(window.top);">
...
<tr><td width="100%"></td><td width="100%" vAlign="center" class="re_dialog">
<input name="local_file" type="file" width="100%" size=46 style="width:100%;height:21" onclick="window.top.window.select_local_file();" onselect="window.top.window.select_local_file();" onblur="window.top.window.select_local_file();" onchange="window.top.window.select_local_file();" onfocus="window.top.window.select_local_file();">
</td></tr>
</table>
