...
var ttFontColor   = "#061940";
var ttBgColor     = "#C6D7FA";
var ttBorderColor = "#114DC7";
...
var ttTitleColor  = "#E3ECFD";    // color of caption text
var ttWidth       = 250;
...
function tt_Htm(tt, t_id, txt)
{
    ...
    t_y += '<tr><td><table border="0" cellpadding="'+t_padd+'" cellspacing="'+t_bw+'" width="100%">' +
        '<tr><td'+(t_bgc? (' bgcolor="'+t_bgc+'"') : '')+(t_bgimg? ' background="'+t_bgimg+'"' : '')+' style="padding:'+t_padd+';text-align:'+t_algn+';';
